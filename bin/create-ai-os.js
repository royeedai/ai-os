...
Options:
  ...
  --with-project-files  Create core project files under ${PROJECT_STATE_ROOT}/ such as project-charter.md, tasks.yaml, STATE.md, verification-matrix.yaml, specs/; other artifacts are generated by workflows when needed
