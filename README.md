...
- 分析现有技术栈、架构、约定、运行拓扑
- 产出 `.ai-os-project/codebase-map.md`
- 回填 `.ai-os-project/verification-matrix.yaml` 和 `.ai-os-project/memory.md`
...
- 补齐 `AGENTS.md`、`.agents/` 和 `.ai-os-project/` 下缺失的基础工件
- 生成 `.ai-os-project/codebase-map.md` 占位模板，供 `/map-codebase` 回填
