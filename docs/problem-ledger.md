...
- **当前覆盖锚点**：`AGENTS.md`（五条核心要求 §2）、`README.md`（Design-aware component-first UI）、`docs/artifacts.md`、`docs/constitution-spec.md`（v2.1）、`framework/skills/ai-os-delivery/SKILL.md`、`framework/.agents/templates/lane/DESIGN.md`、`framework/.agents/templates/lane/verification-matrix.yaml`、`test/docs.test.js`
