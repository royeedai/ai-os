...
7. 初始化 `.ai-os-project/verification-matrix.yaml`，声明关键组件、build/start/restart 命令和冷启动 Smoke 基线
8. 为关键模块预留 `.ai-os-project/specs/*.spec.md`、测试、发布、回滚、文档任务，不允许只拆开发任务
9. 调用 `acceptance-gate` 生成项目级 `.ai-os-project/acceptance.yaml`
10. 建立 `.ai-os-project/risk-register.md`，标出外部依赖、风险等级和人工审批点
11. 初始化 `.ai-os-project/STATE.md`，记录项目当前位置和进度
