...

{
  ...
  assert(toml && toml.includes('framework_version = "9.5.1"'), "framework.toml has version 9.5.1");
...

{
  ...
  assert(result.stdout.trim() === "9.5.1", `--version outputs 9.5.1 (got ${result.stdout.trim()})`);
}
