...

{
  ...
  assert(toml && toml.includes('framework_version = "10.1.0"'), "framework.toml has version 10.1.0");
...

{
  ...
  assert(result.stdout.trim() === "10.1.0", `--version outputs 10.1.0 (got ${result.stdout.trim()})`);
}
