...

{
  ...
  assert(toml && toml.includes('framework_version = "9.5.0"'), "framework.toml has version 9.5.0");
...

{
  ...
  assert(result.stdout.trim() === "9.5.0", `--version outputs 9.5.0 (got ${result.stdout.trim()})`);
}
