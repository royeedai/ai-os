...

{
  ...
  assert(toml && toml.includes('framework_version = "9.5.2"'), "framework.toml has version 9.5.2");
...

{
  ...
  assert(result.stdout.trim() === "9.5.2", `--version outputs 9.5.2 (got ${result.stdout.trim()})`);
}
