...

{
  ...
  assert(parsed && parsed.version === "10.5.1", "JSON reports version 10.5.1");
...

{
  ...
  assert(localJson.version === "10.5.1", "local doctor reports framework version 10.5.1");
  cleanup(dir);
}
...

{
  ...
  assert(parsed.installedVersion === "10.5.1", "local doctor falls back to committed VERSION as installed version");
  cleanup(dir);
}
